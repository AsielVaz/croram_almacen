              ...
              <ul class="side-nav">
                  ...
                  <li class="side-nav-item">
                      ...
                      <div class="collapse" id="sidebarPages">
                          <ul class="sub-menu">
                              <li class="side-nav-item">
                                  <a href="catalogos-familias.php" class="side-nav-link">
                                      <span class="menu-text">Familias principales</span>
                                  </a>
                              </li>
                              <li class="side-nav-item">
                                  <a href="catalogos-sub-familias.php" class="side-nav-link">
                                      <span class="menu-text">Sub Familias</span>
                                  </a>
                              </li>
                  ...
                  <li class="side-nav-item">
                      ...
                      <div class="collapse" id="sidebarPagesAuth">
                          <ul class="sub-menu">
                              <li class="side-nav-item">
                                  <a href="proveedores-alta.php" class="side-nav-link">
                                      <span class="menu-text">Alta nuevo proveedor</span>
                                  </a>
                              </li>
                              <li class="side-nav-item">
                                  <a href="proveedores-ver.php" class="side-nav-link">
                                      <span class="menu-text">Ver proveedores</span>
                                  </a>
                              </li>
                  ...
                  <li class="side-nav-item">
                      <a href="apps-calendar.html" class="side-nav-link">
                          <span class="menu-icon"><i data-lucide="calendar"></i></span>
                          <span class="menu-text"> Rep. proveedores </span>
                      </a>
                  </li>
                  <li class="side-nav-item">
                      <a data-bs-toggle="collapse" href="#sidebarPagesAuthPro" aria-expanded="false"
                          aria-controls="sidebarPagesAuthPro" class="side-nav-link">
                          <span class="menu-icon"><i data-lucide="users"></i></span>
                          <span class="menu-text"> Rep. Artículos</span>
                          <span class="menu-arrow"></span>
                      </a>
                      <div class="collapse" id="sidebarPagesAuthPro">
                          <ul class="sub-menu">
                              <li class="side-nav-item">
                                  <a href="auth-login.html" class="side-nav-link">
                                      <span class="menu-text">Inventario aleatorio.</span>
                                  </a>
                              </li>
                              <li class="side-nav-item">
                                  <a href="auth-register.html" class="side-nav-link">
                                      <span class="menu-text">Inventario seleccionado.</span>
                                  </a>
                              </li>

                              <li class="side-nav-item">
                                  <a href="auth-register.html" class="side-nav-link">
                                      <span class="menu-text">Inventario total.</span>
                                  </a>
                              </li>
                          </ul>
                      </div>
