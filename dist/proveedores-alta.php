            ...
            <div class="page-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h4 class="header-title">Agrega un nuevo proveedor</h4>
                            </div>
                                        ...
                                        <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                            ...
                                            <li class="nav-item">
                                                <a href="#profile-tab-2" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                    <i class="bi bi-emoji-smile fs-18 align-middle me-1"></i>
                                                    <span class="d-none d-sm-inline">Informacion adicional</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#finish-2" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                    <i class="bi bi-check2-circle fs-18 align-middle me-1"></i>
                                                    <span class="d-none d-sm-inline">Términos</span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content b-0 mb-0">
                                            ...
                                            <div class="tab-pane" id="account-2">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="userName1">Nombre</label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="userName1" name="userName1" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="password1">Correo</label>
                                                            <div class="col-md-9">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="password" id="confirm1" name="confirm1" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="rfc">Rfc</label>
                                                            <div class="col-md-9">
                                                                <input type="password" id="rfc" name="rfc" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                         <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="dom">Domicilio</label>
                                                            <div class="col-md-9">
                                                                <input type="password" id="dom" name="dom" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                            ...
                                            <div class="tab-pane" id="profile-tab-2">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="name1"> Crédito</label>
                                                            <div class="col-md-9">
                                                                <input type="text" id="name1" name="name1" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label class="col-md-3 col-form-label" for="surname1"> Plazo de crédito</label>
                                                            <div class="col-md-9">
                                                                <input type="text" id="surname1" name="surname1" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="w-75 mb-2 mx-auto">Acepto que los datos introducidos de este proveedor son correctos y reales.</p>

                                                            <div class="mb-3">
                                                                <div class="form-check d-inline-block">
                                                                    <input type="checkbox" class="form-check-input fs-15" id="customCheck3">
                                                                    <label class="form-check-label" for="customCheck3">Acepto</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> <!-- end col -->
                                            ...
                                            <div class="d-flex wizard justify-content-between flex-wrap gap-2 mt-3">
                                                ...
                                                <div class="d-flex flex-wrap gap-2">
                                                    <div class="previous">
                                                        <a href="javascript:void(0);" class="btn btn-primary">
                                                            <i class="bx bx-left-arrow-alt me-2"></i>Atrás
                                                        </a>
                                                    </div>
                                                    <div class="next">
                                                        <a href="javascript:void(0);" class="btn btn-primary mt-3 mt-md-0">
